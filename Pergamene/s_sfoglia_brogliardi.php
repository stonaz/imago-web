...
if (!isset($_GET['dir'])){$dir="not/NOT081/Ap/01/";}
	else {$dir=$_GET['dir'];}
...
function mostra($row,$dir,$dbserver,$serverIIP,$index,$fileimm,$root)
{
	$file=$row;
	$scansione=$index+1;
	global $catalogo;
...
mostra($row,$dir,$dbserver,$serverIIP,$index,$fileimm,$root);
