...
<div id="outer">
  ...
  <div id="menu"> 
    <ul>
      ...
      <li class="first"><a href="pergamene_intro.html">Pergamene</a></li>
    </ul>
  </div>
<div id="ricerca">
<IFRAME id="cerca" name="cerca" src="search_pergamene.php" width="100%"  height="80" overflow="auto" ></IFRAME>
</div>
...
{ 
echo "<script>location.href='pergamene.php?lar='+screen.width+'&alt='+screen.height;</script>"; 
}  
else 
{
$lar=$_GET['lar'];
$alt=$_GET['alt'];
if ($alt<=768) {print'<IFRAME id="m" name="m" src="menu_pergamene.php" width="100%"  height="526" overflow="auto" ></IFRAME>';}
if ($alt>768)  {print'<IFRAME id="m" name="m" src="menu_pergamene.php" width="100%"  height="800" overflow="auto" ></IFRAME>';}
print'
		</div>
