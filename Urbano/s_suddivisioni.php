...
<tr> 
  	...
  	<tr> 
          ...
          <td  width="34%" class="dati" >'; echo $info[2]."-".$info[5]; print'<br>
            </td>
        </tr>
         <tr> 
 ...
 Sottoserie</td>
        ...
        <tr> 
          <td class="intestazione"  width="24%">Porzioni</td>
          <td class="dati">'; echo $info[6]."-".$info[7];print'<br>
            </td>
        </tr>
        <tr> 
          <td class="intestazione"  width="24%">Foglio</td>
          <td class="dati"> '; echo $info[8]; print'<br>
            </td>
        </tr>
        <tr> 
          <td class="intestazione"  width="24%">Allegato</td>
          <td class="dati">';  echo $info[9];print'<br>
            </td>
        </tr>
        <tr> 
          <td class="intestazione"  width="24%">Data</td>
          <td class="dati">';  echo $info[9];print'<br>
            </td>
        </tr>
        <tr> 
          <td class="intestazione"  width="24%">Note</td>
          <td class="dati">';  echo $info[15];print'<br>
            </td>
        </tr>
        <tr> 
          <td class="intestazione"  width="24%">Scala</td>
          <td class="dati">';  echo $info[12];print'<br>
            </td>
        </tr>
        <tr> 
          <td class="intestazione"  width="24%">Larghezza</td>
          <td class="dati">';  echo $info[10];print'<br>
            </td>
        </tr>
        <tr> 
          <td class="intestazione"  width="24%">Altezza</td>
          <td class="dati">';  echo $info[11];print'<br>
            </td>
        </tr>
        <tr> 
          <td class="intestazione"  width="24%">Autore</td>
