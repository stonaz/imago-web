...
$cont=0;
function leggifileimm($d)
{
	global $cont;
	global $ListaFileImm;
	$cont=0;
	$image_file_array=array("JP2");
	if (!($dp=opendir($d)))  {die("Directory inesistente");}
...
print'<li><A HREF="s_sfoglia_brogliardi.php?Path=';echo $path; print'&r=';echo $fileimm[$i];print'&index=';echo $i; print'" target="s">';echo "#".($i+1);print'</A></li>';
}
?>
