...
';
if ($alt<=768) {print'<IFRAME src="s_sfoglia_brogliardi.php?Path=';echo $path; print'&r1=';echo $r;print'" id="s" name="s" width="100%" height="526" overflow="auto" > </IFRAME>';}
if ($alt>768) {print'<IFRAME src="s_sfoglia_brogliardi.php?Path=';echo $path; print'&r1=';echo $r;print'" id="s" name="s" width="100%" height="800" overflow="auto" > </IFRAME>';}
}
?>
		</div>		
	</div>
