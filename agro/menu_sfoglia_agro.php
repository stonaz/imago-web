...
<FONT  SIZE="+1">&nbsp;&nbsp;MAPPE AGRO ROMANO</FONT>
<ul class="flipMenu">
...
$dbconn = pg_connect ("host=$dbserver port=5432 dbname=agro user=imago_web password=normal.2020") or die ('no db');
...
{
	print'<li><A HREF="s_sfoglia_agro.php?dir=Agro&r=';echo $row[1];print'" target="s">'; echo "<strong>".$row[1]."</strong><br>".$row[2]."</A></li>\n";
}
