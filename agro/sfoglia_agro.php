...
$path="Agro";
$r=$_GET['r1'];
echo "<script>location.href='sfoglia_agro.php?Path=";echo $path."&r=";echo $r."&lar='+screen.width+'&alt='+screen.height;</script>"; 
}  
else 
{
$path="Agro";
...
$lar=$_GET['lar'];
$alt=$_GET['alt'];
if ($alt<=768) {print'<IFRAME id="m" name="m" src="menu_sfoglia_agro.php?Path=';echo $path; print'" width="100%"  height="526" overflow="auto" ></IFRAME>';}
if ($alt>768)  {print'<IFRAME id="m" name="m" src="menu_sfoglia_agro.php?Path=';echo $path; print'" width="100%"  height="800" overflow="auto" ></IFRAME>';}
print'
</div>
<div id="largeContentContainer">
';
if ($alt<=768) {print'<IFRAME src="s_sfoglia_agro.php?dir=';echo $path; print'&r1=';echo $r;print'" id="s" name="s" width="100%" height="526" overflow="auto" > </IFRAME>';}
if ($alt>768) {print'<IFRAME src="s_sfoglia_agro.php?dir=';echo $path; print'&r1=';echo $r;print'" id="s" name="s" width="100%" height="800" overflow="auto" > </IFRAME>';}
}
?>
		</div>		
	</div>
