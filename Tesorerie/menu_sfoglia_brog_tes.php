...
for ($i=0;$i<$cont;$i++)
{
print'<li><A HREF="s_sfoglia_brog_tes.php?dir=';echo $path; print'&r=';echo $fileimm[$i];print'&index=';echo $i; print'" target="s">';echo "#".($i+1);print'</A></li>';
}
?>
