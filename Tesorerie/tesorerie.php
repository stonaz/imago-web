...
<div id="outer">
	<div id="header">
		<h1>IMAGO</h1>
		<h2>ARCHIVIO di STATO di Roma: Tesorerie</h2>
	</div>
	<div id="banner">
...
{ 
echo "<script>location.href='tesorerie.php?lar='+screen.width+'&alt='+screen.height;</script>"; 
}  
else 
{
$lar=$_GET['lar'];
$alt=$_GET['alt'];
if ($alt<=768) {print'<IFRAME id="m" name="m" src="menu_tesorerie.php" width="100%"  height="526" overflow="auto" ></IFRAME>';}
if ($alt>768)  {print'<IFRAME id="m" name="m" src="menu_tesorerie.php" width="100%"  height="800" overflow="auto" ></IFRAME>';}
print'
		</div>

		<div id="largeContentContainer">
';
if ($alt<=768) print'<IFRAME src="s_tesorerie.php" id="s" name="s" width="100%" height="526" overflow="auto" > </IFRAME>';
if ($alt>768) print'<IFRAME src="s_tesorerie.php" id="s" name="s" width="100%" height="800" overflow="auto" > </IFRAME>';
}
?>
		</div>		
	</div>
