...
<li class="first"><a href="discriminazioni_intro.html">Ebrei - discriminazioni</a></li>
...
{
	//echo "test";
echo "<script>location.href='discriminazioni.php?lar='+screen.width+'&alt='+screen.height;</script>"; 
}  
else 
{
...
if ($alt<=768) {print'<IFRAME id="m" name="m" src="menu.html" width="100%"  height="526" overflow="auto" ></IFRAME>';}
if ($alt>768)  {print'<IFRAME id="m" name="m" src="menu.html" width="100%"  height="800" overflow="auto" ></IFRAME>';}
print'
		</div>

		<div id="largeContentContainer">
';
if ($alt<=768) print'<IFRAME src="login.php" id="s" name="s" width="100%" height="526" overflow="auto" > </IFRAME>';
if ($alt>768) print'<IFRAME src="login.php" id="s" name="s" width="100%" height="800" overflow="auto" > </IFRAME>';
}
?>
		</div>		
	</div>
