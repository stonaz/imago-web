...
<div id="outer">
	<div id="header">
		<h1>IMAGO</h1>
		<h2>Catasto rustico della provincia di Roma, versamento U.T.E. </h2>
	</div>
	<div id="banner">
...
<li class="first"><a href="ute_intro.html"> Catasto rustico della provincia di Roma, versamento U.T.E. </a></li>
...
<div id="ricerca">
<IFRAME id="cerca" name="cerca" src="search_ute.php" width="100%"  height="70" overflow="auto" ></IFRAME>
</div>
...
{ 
echo "<script>location.href='ute.php?lar='+screen.width+'&alt='+screen.height;</script>"; 
}  
else 
{
$lar=$_GET['lar'];
$alt=$_GET['alt'];
if ($alt<=768) {print'<IFRAME id="m" name="m" src="menu_ute.php" width="100%"  height="526" overflow="auto" ></IFRAME>';}
if ($alt>768)  {print'<IFRAME id="m" name="m" src="menu_ute.php" width="100%"  height="800" overflow="auto" ></IFRAME>';}
print'
		</div>
