...
<p align='right'>	<a style="font-size: 10pt; color: yellow" href="http://www.archiviodistatoroma.beniculturali.it/">
	...
	<div id="menu">
		...
		<li><a href="mappette.php">Mappette</a></li>
		</ul>
	</div>
...
';
if ($alt<=768) {print'<IFRAME src="s_sfoglia_brogliardi.php?dir=';echo $path; print'&r=';echo $r;print'" id="s" name="s" width="100%" height="526" overflow="auto" > </IFRAME>';}
if ($alt>768) {print'<IFRAME src="s_sfoglia_brogliardi.php?dir=';echo $path; print'&r=';echo $r;print'" id="s" name="s" width="100%" height="800" overflow="auto" > </IFRAME>';}
}
?>
		</div>		
	</div>
