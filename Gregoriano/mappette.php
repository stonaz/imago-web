...
<div id="outer">
	<div id="header">
		<h1>IMAGO</h1>
		<h2>Catasto Gregoriano - Centri urbani</h2>
	</div>
	<div id="banner">
<p align='right'>	<a style="font-size: 10pt; color: yellow" href="http://www.archiviodistatoroma.beniculturali.it/">
	...
	<div id="menu">
		...
		<li ><a href="gregoriano_intro.html">Catasto Gregoriano</a></li>
			<li><a href="brogliardi.php">Brogliardi</a></li>
		<li  ><a href="mappe.php">Mappe</a></li>
		<li class="first"><a href="mappette.php">Mappette</a></li>
		</ul>
	</div>
...
{ 
echo "<script>location.href='mappette.php?lar='+screen.width+'&alt='+screen.height;</script>"; 
}  
else 
{
$lar=$_GET['lar'];
$alt=$_GET['alt'];
if ($alt<=768) {print'<IFRAME id="m" name="m" src="menu_mappette.php" width="100%"  height="526" overflow="auto" ></IFRAME>';}
if ($alt>768)  {print'<IFRAME id="m" name="m" src="menu_mappette.php" width="100%"  height="800" overflow="auto" ></IFRAME>';}
print'
		</div>

		<div id="largeContentContainer">
';
if ($alt<=768) print'<IFRAME src="s_mappette.php" id="s" name="s" width="100%" height="526" overflow="auto" > </IFRAME>';
if ($alt>768) print'<IFRAME src="s_mappette.php" id="s" name="s" width="100%" height="800" overflow="auto" > </IFRAME>';
}
?>
		</div>		
	</div>
