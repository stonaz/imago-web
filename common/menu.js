...
//Margine sinistro dal browser al menu
	flipLeftMargin = "16px";

//Margine alto dal browser al menu
	flipTopMargin = "10px";

// ## Allow multiple menus to fold out without closing all the other open ones.
	flipOpenMultipleMenus = true;

// Salva stato menu dopo ogni click
...
// Immagini
	flipImg_open   = "../../common/folder_open.gif";
	flipImg_closed = "../../common/folder_closed.gif";
	flipImg_static = "../../common/letter.gif";

// Carcica menu
	flipInitOnLoad = true;

// Messaggio di caricamento
	flipLoadingMessage = "Caricamento...";
